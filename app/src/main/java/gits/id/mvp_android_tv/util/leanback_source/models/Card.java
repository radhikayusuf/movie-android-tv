...
package gits.id.mvp_android_tv.util.leanback_source.models;
...
public class Card {
    ...
    @SerializedName("width") private int mWidth = 0;
    @SerializedName("height") private int mHeight = 0;
    private String mBackdgroundUrl;
    ...
    public String getBackdgroundUrl() {
        return mBackdgroundUrl;
    }

    public void setBackdgroundUrl(String mBackdgroundUrl) {
        this.mBackdgroundUrl = mBackdgroundUrl;
    }
